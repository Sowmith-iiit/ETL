...
function dropcopy(ev)
                    ...
                    p = "<div class=\"row\" id=\""+ val ;
		    l = "\">" +"<div class=\"box0 col-md-2\">"+"<button class=\"btn btn-primary btn-xs\" data-toggle=\"modal\" data-target=\"#myModal\">" +
                 map[count] +
                "</button>" +"</div></div>  <br>       ";     
                    target.innerHTML = target.innerHTML + p + l;
